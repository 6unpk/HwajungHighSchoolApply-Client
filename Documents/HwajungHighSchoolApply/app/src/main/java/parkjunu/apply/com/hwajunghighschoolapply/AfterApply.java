...
public class AfterApply extends AppCompatActivity {
    ListView listView;
    ApplyListAdapter applyListAdapter;
    ArrayList<SimpleListItem> items = new ArrayList<>();
    static final String HOST_ADDRESS_AFTER_APPLY_LIST = "http://45.32.52.41:5000/class_apply_list";
    static final String HOST_ADDRESS_AFTER_APPLY_TABLE = "http://45.32.52.41:5000/class_apply_table";
    ...
    private class GetTable extends AsyncTask<Void, Void, Void> {
        ...
        public GetTable(String select){
            progressDialog = new ProgressDialog(AfterApply.this);
            link = select;
        ...
        protected Void doInBackground(Void... params) {
            try {
                url = new URL(HOST_ADDRESS_AFTER_APPLY_TABLE);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Intent intent = new Intent(getApplicationContext(), AfterApplyTable.class);
    ...
    private class GetList extends AsyncTask<Void, Void, Void>{
        ...
        public GetList(){
            dialog = new ProgressDialog(AfterApply.this);
        ...
        protected Void doInBackground(Void... params) {
            try {
                url = new URL(HOST_ADDRESS_AFTER_APPLY_LIST);
                HttpClient httpClient = new DefaultHttpClient();
                HttpPost httpPost = new HttpPost();
                httpPost.setURI(url.toURI());
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            try {
                ...
                for(int i = 0; i < jsonObject.length(); ++i){
                    ...
                    String target = jsonObject.getJSONObject(""+(i+1)).getString("title");
